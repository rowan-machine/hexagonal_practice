...
**Tests written?** Continue with:

1. **[docs/BEST_PRACTICES.md](../docs/BEST_PRACTICES.md)** → Testing best practices and patterns
2. **[CONTRIBUTING.md](../CONTRIBUTING.md)** → Contribution guidelines
3. **[examples/README.md](../examples/README.md)** → See examples of tested code
...
3. Review existing tests in `src/tests/` for patterns

**Ready to contribute?**

1. **[CONTRIBUTING.md](../CONTRIBUTING.md)** → Submit your tests
2. **[docs/DESIGN_PRINCIPLES.md](../docs/DESIGN_PRINCIPLES.md)** → Understand architecture for better tests
3. **[config/PIPELINE_CONFIG_GUIDE.md](../config/PIPELINE_CONFIG_GUIDE.md)** → Test your pipeline configurations
