...
- [ ] `config/claims_pipeline.yml` - Valid YAML
- [ ] `config/policies_pipeline.yml` - Valid YAML
...
- [ ] `README.md` → Architecture Overview section - Architecture documented
...
**All tests passing?** Continue with:

1. **[TESTING.md](TESTING.md)** → Learn more testing patterns and best practices
2. **[docs/BEST_PRACTICES.md](../docs/BEST_PRACTICES.md)** → Testing best practices
3. **[CONTRIBUTING.md](../CONTRIBUTING.md)** → Submit your tests

**Want to improve coverage?**

1. Review test files in `src/tests/` for patterns
2. **[docs/BEST_PRACTICES.md](../docs/BEST_PRACTICES.md)** → Testing guidelines
3. **[examples/README.md](../examples/README.md)** → See tested code examples

**Ready to develop?**

1. **[docs/DESIGN_PRINCIPLES.md](../docs/DESIGN_PRINCIPLES.md)** → Understand architecture for better tests
2. **[config/PIPELINE_CONFIG_GUIDE.md](../config/PIPELINE_CONFIG_GUIDE.md)** → Test your pipeline configurations
3. **[sql_migration/README.md](../sql_migration/README.md)** → Test SQL migrations
